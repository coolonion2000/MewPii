...
const dict = {
  zh: {
    ...
    runsIdle: '{n} 个会话',
    subagentOpenParent: '子 agent 运行中，点击打开父会话（会话文件将在其首次回复后出现）',
    idle: '空闲',
    queuedSteer: '介入中',
    queuedFollowUp: '排队中',
    sendSteer: '介入',
  ...
  en: {
    ...
    runsIdle: '{n} sessions',
    subagentOpenParent: 'Subagent running — click to open the parent session (session file appears after its first reply)',
    idle: 'idle',
