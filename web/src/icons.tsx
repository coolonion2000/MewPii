...
export const IconArrowUp = (p: IconProps) => base(p, <><path d="M12 19V5" /><path d="m5 12 7-7 7 7" /></>);
export const IconStop = (p: IconProps) => base(p, <rect x="7" y="7" width="10" height="10" rx="2" />, true);
